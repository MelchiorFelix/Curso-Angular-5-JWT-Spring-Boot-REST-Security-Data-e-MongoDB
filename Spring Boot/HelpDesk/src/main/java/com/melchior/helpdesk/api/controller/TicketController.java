package com.melchior.helpdesk.api.controller;
...
import com.melchior.helpdesk.api.dto.Summary;
import com.melchior.helpdesk.api.response.Response;
...
import com.melchior.helpdesk.api.security.jwt.JwtTokenUtil;
import com.melchior.helpdesk.api.service.TicketService;
...
public class TicketController {
	...
	private void validateCreateTicket(Ticket ticket, BindingResult result) {
		if (ticket.getTitle() == null) {
			result.addError(new ObjectError("Ticket", "Tittle no informed"));
			return;
		}
	}
	...
	public ResponseEntity<Response<Page<Ticket>>> findAll(HttpServletRequest request,@PathVariable("page") int page, 
		...
		if(userRequest.getProfile().equals(ProfileEnum.ROLE_TECHICIAN)) {
	...
	public ResponseEntity<Response<Summary>> findSummary(){
		...
		if(tickets != null) {
			for (Iterator<Ticket> iterator = tickets.iterator(); iterator.hasNext();) {
				...
				if(ticket.getStatus().equals(StatusEnum.Dissapproved)) {
					amountDisapproved++;
				}
